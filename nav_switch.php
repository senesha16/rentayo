...
if ($is_admin === 1) {
    ...
    if ($inAdmin) {
        ...
        <div class="navbar">
          <div class="left">
            <a href="<?php echo $dashUrl; ?>" class="logo-link"><span class="logo-text">RENTayo • Admin</span></a>
          </div>
          <div class="right">
        ...
        .logo-link{color:#FAF7F3;text-decoration:none}.logo-text{font-size:18px;font-weight:700;letter-spacing:.5px}
